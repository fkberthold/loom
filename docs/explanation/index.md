...
- [**Mental model**](mental-model.md) — the four-axis memory split
  ...
  four axes was load-bearing rather than cosmetic.
- [**The recipe family**](recipe-family.md) — why six activity
  recipes instead of one, what each shape's central inversion is,
...
- [**Provenance**](provenance.md) — loom's lineage: v1
  ...
  v2 (sibling recipes + bead-lifecycle-shell extraction), and the
